...
int ctrl_cmd_string(struct engine_factory_instance *instance, ENGINE *e,
                    int cmd, long i, void *p, void (*f)(void));
...
/* aes256 cbc mapping*/
int aes256_cbc_init(struct engine_factory_instance *instance,
...
/* aes256 gcm mapping*/
int aes256_gcm_init(struct engine_factory_instance *instance,
                    EVP_CIPHER_CTX *ctx, const unsigned char *key,
                    const unsigned char *iv, int enc);
...
/* chacha20 mapping*/
int chacha20_init(struct engine_factory_instance *instance, EVP_CIPHER_CTX *ctx,
...
/* private key loader */
EVP_PKEY *load_private_key(struct engine_factory_instance *instance,
                           const char *keyfile);
/* public key loader */
EVP_PKEY *load_public_key(struct engine_factory_instance *instance,
                          const char *keyfile);
